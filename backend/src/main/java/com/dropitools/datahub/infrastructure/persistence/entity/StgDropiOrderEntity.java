...
@Entity
@Table(name = "stg_dropi_order")
@Getter
@Setter
public class StgDropiOrderEntity {
    ...
    @Column(name = "orden_de_dropshipper") private String ordenDeDropshipper;
    ...
    @Column(name = "numero_de_factura") private String numeroDeFactura;
    @Column(name = "valor_facturado") private String valorFacturado;
    ...
    @Column(name = "fecha_generacion_de_guia") private String fechaGeneracionDeGuia;
    @Column(name = "usuario_generacion_de_guia") private String usuarioGeneracionDeGuia;
    ...
    @Column(name = "categorias", columnDefinition = "VARCHAR(500)") private String categorias;
